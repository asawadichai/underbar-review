  ...
  _.uniq = function (array, isSorted, iterator) {
    ...
    if (iterator === undefined) {
      for (var i = 0; i < array.length; i++) {
        if (uniqueTest[array[i]] === undefined) {
          uniqueTest[array[i]] = 'exists';
          result.push(array[i]);
        }
      }
    } else {
      for (var i = 0; i < array.length; i++) {
        if (uniqueTest[iterator(array[i])] === undefined) {
          uniqueTest[iterator(array[i])] = 'exists';
          result.push(array[i]);
        }
      }
    }
